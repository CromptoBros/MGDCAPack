...
const entityStages = {
  'minecraft:creeper': 'no_creepers',
  'alexsmobs:fly': 'no_alex_arthopods',
  'alexsmobs:crimson_mosquito': 'no_alex_arthopods',
  'alexsmobs:centipede_head': 'no_alex_arthopods',
  'alexsmobs:centipede_body': 'no_alex_arthopods',
  'alexsmobs:centipede_tail': 'no_alex_arthopods',
  'alexsmobs:cockroach': 'no_alex_arthopods',
  'alexsmobs:tarantula_hawk': 'no_alex_arthopods',
  'mekanismadditions:baby_skeleton': 'no_mekanism_additions_mobs',
  'mekanismadditions:baby_creeper': 'no_mekanism_additions_mobs',
  'mekanismadditions:baby_enderman': 'no_mekanism_additions_mobs',
  'mekanismadditions:baby_skeleton': 'no_mekanism_additions_mobs',
  'mekanismadditions:baby_stray': 'no_mekanism_additions_mobs',
  'mekanismadditions:baby_wither_skeleton': 'no_mekanism_additions_mobs',
  'ars_nouveau:wilden_hunter': 'no_ars_nouveau_mobs',
  'ars_nouveau:wilden_stalker': 'no_ars_nouveau_mobs',
  'ars_nouveau:wilden_guardian': 'no_ars_nouveau_mobs',
}

const modStages = {
  cnb: 'no_cnb',
  crittersandcompanions: 'no_critters',
  alexsmobs: 'no_alexs_mobs',
}
