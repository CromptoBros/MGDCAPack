  ...
  ponder
    ...
    .scene(
      ...
      (scene, util) => {
        ...
        scene.text(
          80,
          'The Industrial Turbine is a multiblock that uses Steam to generate massive amounts of FE.'
        )
        scene.idle(90)
        ...
        scene.world.modifyBlockEntityNBT([5, 2, 5, 2, 8, 5], (nbt) => {
          nbt.blades = 0
        })
        ...
        scene
          .showControls(60, [5.5, 9, 5.5], 'down')
          .rightClick()
          .withItem('mekanismgenerators:turbine_blade')

        for (let y = 2; y <= 8; y++) {
          scene.world.modifyBlockEntityNBT([5, y, 5], (nbt) => {
            nbt.blades = 1
          })
          scene.idle(3)
          scene.world.modifyBlockEntityNBT([5, y, 5], (nbt) => {
        ...
        scene.text(
          70,
          'If the Blades reach out far enough they would go through the walls...'
        )
        scene.idle(20)
        ...
        scene.text(
          80,
          '...then you have to make the Turbine either shorter or wider.'
        )
        scene.idle(20)
        ...
        scene.text(
          80,
          'The walls can be made of Structural Glass, but the corners must be Turbine Casing.'
        )
        scene.idle(15)
        ...
        scene.text(
          80,
          '...and completely fill the rest of that layer with Pressure Dispersers.'
        )
        scene.idle(90)
        ...
        scene.text(
          80,
          'The more room under this layer, the more Steam the Turbine can hold.'
        )
        scene.idle(90)
        ...
        scene.text(
          70,
          'Place an Electromagnetic Coil on the Rotational Complex.'
        )
        scene.idle(80)
        scene.text(
          100,
          'The amount of Coils (and of Rotor Blades) is what decides how much FE is generated.'
        )
        scene.idle(45)
        ...
        scene.text(
          100,
          'The amount of Vents (and of Presssure Dispersers) is what decides the flow rate.'
        )
        scene.idle(110)
        scene.text(
          85,
          'Higher flow rate means more Steam is used, and more FE is produced.'
        )
        scene.idle(95)
        ...
        scene.text(
          100,
          'You can also place some Saturating Condensers down, which let you pull Water out of the vents.'
        )
        scene.world.setBlocks(
          [5, 11, 3, 7, 11, 7],
          'mekanismgenerators:saturating_condenser',
        ...
        scene.world.setBlock([1, 1, 3], 'mekanism:elite_fluid_tank', false)

        scene.world.showSection([1, 1, 3, 1, 9, 3], Facing.EAST)
        ...
        scene
          .text(60, 'Place a Valve for Steam input...', [7.5, 2.5, 2.5])
          .placeNearTarget()
        scene.idle(70)
        scene.world.setBlock(
          [3, 2, 2],
        ...
        scene
          .text(60, '...and another for FE output!', [3.5, 2.5, 2.5])
          .placeNearTarget()
        scene.idle(70)
      }
    )
